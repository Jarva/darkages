...
SWEP.PrintName        = "Mithril Scimitar"			
SWEP.Slot		= 3
SWEP.SlotPos		= 2
SWEP.DrawAmmo		= false
...
SWEP.ViewModel			= "models/PG_props/pg_weapons/pg_scimitar_sword_v.mdl"
SWEP.WorldModel		= "models/PG_props/pg_weapons/pg_scimitar_sword_w.mdl"
